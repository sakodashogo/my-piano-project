            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                    ...
                                    <div className="flex-1">
                                        <div className="flex items-start justify-between mb-3">
                                            <div>
                                                ...
                                                <p className="text-sm text-slate-500">{item.piece}</p>
                                            </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="glass-card p-5">
                        ...
                        <button className="w-full py-3 bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded-xl font-medium text-slate-300 transition-colors flex items-center justify-center gap-2">
                            <Calendar className="w-4 h-4" />
                            カレンダーを開く
                        </button>
                        <p className="text-xs text-slate-600 mt-3 text-center">
                            ※ Google Calendar API連携は今後実装予定
                        </p>
                    </div>
                </div>
            </div>
