            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 gap-2">
                            {STUDENTS.map((student) => (
                                <button
                                    ...
                                    className={`p-4 rounded-xl text-left transition-all ${selectedStudent.id === student.id
                    ...
                    <div className="glass-card p-6">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 bg-slate-800/50 border border-slate-700 rounded-xl text-slate-100 placeholder:text-slate-600"
                            placeholder="例: テンポが安定していた"
                        />
                    </div>
                </div>
                ...
                <div className="glass-card p-6 flex flex-col">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <button
                            onClick={handleCopy}
                            className={`flex items-center gap-2 px-4 py-2 rounded-xl font-medium transition-all ${copied
                    ...
                    <div className="flex-1 bg-slate-800/50 border border-slate-700 rounded-xl p-5 whitespace-pre-wrap text-slate-300 leading-relaxed">
                        {generateMessage()}
                    </div>
                    <p className="text-sm text-slate-500 mt-4 text-center">
                        コピーしたメッセージをLINEに貼り付けて送信してください
                    </p>
                </div>
            </div>
        </div>
